...
public class hjwzwBookInfoActivity extends AppCompatActivity {

    Activity activity = this;
    private ImageView imageView;
    private hjwzwBookDetail bookInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hjwzw_book_info);
        ...
        new Thread(() -> {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    chapterListAdapter = new ChapterListAdapter(activity,bookInfo.getChapterName(),bookInfo.getChapterHTML(), bookInfo.getName(),"hjwzw");
